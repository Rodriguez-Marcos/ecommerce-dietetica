...
function _getProducts() {
  _getProducts = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res) {
    var _req$query, name, id_category, id_diet, priceL, priceH, sortby, id, _products, products, productsName, productsFound;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            return _context2.abrupt("return", res.status(200).json(_products));
